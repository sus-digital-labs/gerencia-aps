...
import { 
  FileText, Plus, Download, BarChart3, Syringe, ClipboardList, 
  FileSpreadsheet, RefreshCw, Users, Activity
} from 'lucide-react';
      ...
      <div className="max-w-[1600px] mx-auto px-6 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="bg-white/80 shadow-lg p-1 h-auto flex-wrap">
            <TabsTrigger value="producao" className="gap-2 data-[state=active]:bg-blue-500 data-[state=active]:text-white">
              <BarChart3 className="w-4 h-4" />
              Produção
            </TabsTrigger>
            <TabsTrigger value="bpa" className="gap-2 data-[state=active]:bg-indigo-500 data-[state=active]:text-white">
              <FileText className="w-4 h-4" />
              BPA
            </TabsTrigger>
            <TabsTrigger value="ras" className="gap-2 data-[state=active]:bg-cyan-500 data-[state=active]:text-white">
              <ClipboardList className="w-4 h-4" />
              RAS
            </TabsTrigger>
            <TabsTrigger value="imunizacao" className="gap-2 data-[state=active]:bg-green-500 data-[state=active]:text-white">
              <Syringe className="w-4 h-4" />
              Imunização
            </TabsTrigger>
            <TabsTrigger value="comparativo" className="gap-2 data-[state=active]:bg-purple-500 data-[state=active]:text-white">
              <Users className="w-4 h-4" />
              Comparativo
            </TabsTrigger>
            <TabsTrigger value="incidencia" className="gap-2 data-[state=active]:bg-amber-500 data-[state=active]:text-white">
