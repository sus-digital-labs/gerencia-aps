                  ...
                  >
                    ...
                    <div className="text-center">
                      <div className="flex items-center gap-1">
                        {Array.from({
                          length: Math.min(title.quantidade, 4),
                        }).map((_, i) => (
                          <motion.span
                            key={i}
                            initial={{ scale: 0 }}
