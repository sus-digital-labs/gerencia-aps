    ...
    return (
      ...
      >
        ...
        <Avatar className="h-8 w-8">
          ...
          <AvatarFallback
            className={position <= 3 ? "bg-white/20 text-white" : "bg-gray-100"}
          >
            {acs_name?.charAt(0)}
          </AvatarFallback>
        </Avatar>
        <div className="flex-1 min-w-0">
          <p
            className={`font-medium text-sm truncate ${position <= 3 ? "" : "text-gray-800"}`}
          >
            {acs_name}
          </p>
        </div>
    ...
    >
      ...
      <div className="p-4">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <p
              className={`font-bold text-lg truncate ${position <= 3 ? "" : "text-gray-800"}`}
            >
              {acs_name}
            </p>
            <p
              className={`text-sm truncate ${position <= 3 ? "text-white/70" : "text-gray-500"}`}
            >
              {unit_name}
            </p>
            <Badge
          ...
          <div className="text-right">
            ...
            <p
              className={`text-xs ${position <= 3 ? "text-white/70" : "text-gray-500"}`}
            >
              pontos
            </p>
          </div>
