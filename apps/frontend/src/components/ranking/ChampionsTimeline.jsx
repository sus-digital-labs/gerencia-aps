...
export default function ChampionsTimeline({
  ...
  const monthRankings = selectedMonth
    ? rankings
        .filter(r => r.month === selectedMonth && r.year === year)
                  ...
                  >
                    ...
                    >
                      {champion ? (
                        ...
                        <div
                          className={`h-12 w-12 rounded-full border-4 border-dashed ${
                            isPast
              ...
              monthRankings.slice(0, 10).map((ranking, idx) => (
                ...
                >
                  ...
                  <Avatar className="h-10 w-10">
                    ...
                    <AvatarFallback
                      className={
                        ranking.position <= 3 ? "bg-white/20" : "bg-gray-100"
                      }
                    >
                  ...
                  <div className="flex-1">
                    ...
                    <p
                      className={`text-xs ${ranking.position <= 3 ? "text-white/70" : "text-gray-500"}`}
                    >
                      {ranking.unit_name}
                    </p>
                  </div>
