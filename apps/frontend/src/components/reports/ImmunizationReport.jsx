...
export default function ImmunizationReport({ citizens = [] }) {
  ...
  // Este componente não infere produção a partir do cadastro de cidadãos.
  const vaccinationData = useMemo(() => {
    void citizens;
    return {};
  }, [citizens, filters.year]);
  ...
  const stats = useMemo(() => {
    ...
    return {
      ...
      avgCoverage:
        vaccines.length > 0
          ? Math.round(
              (vaccines.reduce((sum, v) => sum + v.coverage, 0) /
                vaccines.length) *
                10
            ) / 10
          : 0,
  ...
  const selectedVaccine =
    filters.vaccine !== "all" ? vaccinationData[filters.vaccine] : null;
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-white/80">
                  Monitoramento da cobertura vacinal do município
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={v => setFilters({ ...filters, vaccine: v })}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                value={filters.dose}
                onValueChange={v => setFilters({ ...filters, dose: v })}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">
                    {stats.totalDoses.toLocaleString()}
                  </p>
                ...
                {Object.values(vaccinationData).map((vaccine, idx) => (
                  <TableRow key={vaccine.id} className="hover:bg-gray-50">
                    ...
                    <TableCell className="text-center">
                      {vaccine.targetPopulation.toLocaleString()}
                    </TableCell>
                    <TableCell className="text-center font-bold">
                      {vaccine.appliedDoses.toLocaleString()}
                    </TableCell>
                    <TableCell className="text-center font-bold">
                      {vaccine.coverage}%
                    </TableCell>
