...
const DATA_SOURCES = {
  citizens: {
    label: "Cidadãos",
    fields: ["nome", "cpf", "cns", "idade", "sexo", "microarea", "conditions"],
  },
  visits: {
  ...
  acs: {
    ...
    fields: ["name", "microarea", "team_id", "phone", "hire_date"],
  },
  indicators: {
    label: "Indicadores",
    fields: [
...
export default function ReportBuilder({ existingReport = null, onSave }) {
  ...
  const handleRemoveField = field => {
    setFormData({
      ...
      query_config: {
        ...formData.query_config,
        fields: formData.query_config.fields.filter(f => f !== field),
      },
    });
  };
  ...
  const handleRemoveFilter = index => {
    setFormData({
      ...
      query_config: {
        ...formData.query_config,
        filters: formData.query_config.filters.filter((_, i) => i !== index),
      },
    });
  };
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex flex-wrap gap-2">
                {formData.query_config.fields?.map(field => (
        ...
        <TabsContent value="filters" className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              {formData.query_config.filters?.map((filter, idx) => (
                <div key={idx} className="flex gap-3 items-end">
                  <div className="flex-1 space-y-2">
                    <Label>Campo</Label>
                    <Select
                      value={filter.field}
                      onValueChange={v => handleUpdateFilter(idx, "field", v)}
                    >
                      <SelectTrigger>
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={v =>
                        handleUpdateFilter(idx, "operator", v)
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={v =>
                    setFormData({ ...formData, export_format: v })
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={v =>
                          setFormData({ ...formData, schedule_frequency: v })
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
                  ...
                  {formData.schedule_frequency !== "daily" && (
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        min="1"
                        max={
                          formData.schedule_frequency === "weekly" ? "7" : "31"
                        }
                      />
                    </div>
                  )}
