...
export default function NotificationSettings() {
  ...
  const { data: savedConfig } = useQuery({
    ...
    queryFn: async () => {
      const configs = await trpc.SystemConfig.filter({
              ...
              <div className="ml-8 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={checked =>
                      setSettings({ ...settings, email_critical_only: checked })
                    }
                  />
                </div>
              </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Notificar quando pacientes de alto risco não forem visitados
                </p>
              </div>
            </div>
            <div className="ml-8 space-y-3">
              <div className="flex items-center gap-3">
                ...
                <Input
                  ...
                  onChange={e =>
                    setSettings({
                      ...settings,
                      cv_risk_threshold_days: parseInt(e.target.value),
                    })
                  }
                  className="w-24"
                  min="1"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Alertas sobre problemas graves de qualidade
                  </p>
                </div>
              </div>
              <Switch
                ...
                onCheckedChange={checked =>
                  setSettings({ ...settings, data_quality_critical: checked })
                }
              />
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={checked =>
                  setSettings({ ...settings, new_tasks_assigned: checked })
                }
              />
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Alertar quando visitas não forem realizadas no prazo
                </p>
              </div>
            </div>
            <div className="ml-8 space-y-3">
              <div className="flex items-center gap-3">
                ...
                <Input
                  ...
                  onChange={e =>
                    setSettings({
                      ...settings,
                      visit_overdue_threshold_days: parseInt(e.target.value),
                    })
                  }
                  className="w-24"
                  min="1"
