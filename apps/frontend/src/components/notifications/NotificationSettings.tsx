...
interface SettingsData {
  ...
  cv_risk_threshold_days: number;
  data_quality_critical: boolean;
  new_tasks_assigned: boolean;
  visit_overdue_threshold_days: number;
  [key: string]: any;
}
...
export default function NotificationSettings() {
  ...
  useEffect(() => {
    if (savedConfig && savedConfig.value) {
      setSettings((prev) => ({ ...prev, ...savedConfig.value as Partial<SettingsData> }));
    }
  }, [savedConfig]);
