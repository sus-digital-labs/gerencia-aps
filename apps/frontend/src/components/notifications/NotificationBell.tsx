...
import { 
  Bell, AlertTriangle, TrendingDown, Calendar, Users, 
  Activity, Check, CheckCheck, X, ExternalLink 
} from 'lucide-react';
                ...
                return (
                  ...
                  >
                    <div className="flex gap-3">
                      <div className={`p-2 rounded-lg ${priorityColors[notification.priority] || priorityColors.baixa}`}>
