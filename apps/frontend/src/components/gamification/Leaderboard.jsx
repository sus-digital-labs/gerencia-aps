...
export default function Leaderboard({ teams, showPodium = true }) {
  ...
  const getPodiumStyle = rank => {
    switch (rank) {
      case 1:
        return "bg-gradient-to-br from-yellow-50 to-amber-100 border-yellow-300 ring-2 ring-yellow-200";
      case 2:
        return "bg-gradient-to-br from-gray-50 to-gray-100 border-gray-300";
      case 3:
        return "bg-gradient-to-br from-orange-50 to-amber-50 border-amber-200";
      default:
        return "bg-white";
    }
  };
        ...
        {showPodium && topThree.length > 0 && (
          <div className="grid grid-cols-3 gap-4 mb-8">
            ...
            >
              {topThree[1] && (
                <div
                  className={`w-full rounded-2xl p-4 border-2 ${getPodiumStyle(2)} text-center`}
                >
                  ...
                  <Badge
                    className={`mt-2 ${teamTypeColors[topThree[1].team_type]}`}
                  >
            ...
            >
              {topThree[0] && (
                <div
                  className={`w-full rounded-2xl p-4 border-2 ${getPodiumStyle(1)} text-center`}
                >
                  <div className="flex justify-center mb-2">
                    {getPodiumIcon(1)}
                  </div>
                  ...
                  <Badge
                    className={`mt-2 ${teamTypeColors[topThree[0].team_type]}`}
                  >
            ...
            >
              {topThree[2] && (
                <div
                  className={`w-full rounded-2xl p-4 border-2 ${getPodiumStyle(3)} text-center`}
                >
                  <div className="flex justify-center mb-2">
                    {getPodiumIcon(3)}
                  </div>
                  ...
                  <Badge
                    className={`mt-2 ${teamTypeColors[topThree[2].team_type]}`}
                  >
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge
                      className={`${teamTypeColors[team.team_type]} text-xs`}
                    >
                      {team.team_type}
                    </Badge>
                ...
                <div className="text-right">
                  <div className="font-bold text-gray-800">
                    {team.total_score?.toLocaleString()} pts
                  </div>
                </div>
              </motion.div>
            ))}
