...
const navigation = [
  ...
  },
  {
    ...
    subItems: [
      { name: "Visitas e ACS", href: "/acs" },
      { name: "Ranking ACS", href: "/acs/ranking" },
      { name: "Tarefas Pendentes", href: "/acs/tarefas" },
    ],
  },
  {
    name: "Território",
    ...
    subItems: [
      { name: "Mapa do Território", href: "/territorio" },
      { name: "Remapeamento", href: "/territorio/remapeamento" },
    ],
  },
  {
    name: "Vigilância",
    ...
    subItems: [
      { name: "Aedes aegypti", href: "/vigilancia/aedes" },
      { name: "Risco Cardiovascular", href: "/vigilancia/cardiovascular" },
    ],
  },
  {
    name: "Relatórios",
    href: "/relatorios",
    icon: Target,
    description: "Produção, BPA, RAS, Imunização",
  },
  {
  ...
  },
  {
    ...
    href: "/gamificacao",
    icon: Trophy,
    description: "Ranking e conquistas",
  },
  {
    name: "Equipes",
    href: "/equipes",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="flex flex-col h-full">
          {/* Logo */}
          <div
            className={`flex items-center h-16 px-4 border-b ${isCollapsed ? "justify-center" : "gap-3"}`}
          >
          ...
          <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
            {navigation.map(item => {
              ...
              const isSubActive =
                hasSubItems && item.subItems.some(sub => isActive(sub.href));
              ...
              return (
                <div key={item.name}>
                  ...
                  >
                    <item.icon
                      className={`w-5 h-5 ${active || isSubActive ? "text-blue-600" : "text-gray-400"}`}
                    />
                    {!isCollapsed && (
                      <div className="flex-1">
                        <span
                          className={`font-medium ${active || isSubActive ? "text-blue-600" : ""}`}
                        >
                          {item.name}
                        </span>
          ...
          {user && (
            <div
              className={`p-4 border-t ${isCollapsed ? "flex justify-center" : ""}`}
            >
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button
                    className={`flex items-center gap-3 w-full p-2 rounded-xl hover:bg-gray-100 transition-colors ${isCollapsed ? "justify-center" : ""}`}
                  >
