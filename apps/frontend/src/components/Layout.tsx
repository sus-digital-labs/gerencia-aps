...
const navigation = [
  { name: 'Dashboard', href: '/', icon: LayoutDashboard, description: 'Visão geral dos indicadores' },
  { 
    name: 'Gestão ACS', 
    href: '/acs', 
    icon: Users, 
  ...
  { name: 'Relatórios', href: '/relatorios', icon: Target, description: 'Produção, BPA, RAS, Imunização' },
  { name: 'Qualidade de Dados', href: '/qualidade', icon: Shield, description: 'Gestão de cadastros' },
  { name: 'Gamificação', href: '/gamificacao', icon: Trophy, description: 'Ranking e conquistas' },
  { name: 'Equipes', href: '/equipes', icon: Building2, description: 'Gestão de equipes' },
  { name: 'Configurações', href: '/configuracoes', icon: Settings, description: 'Sistema e usuários' },
];
