...
export default function ActiveSearch() {
  ...
  const searchResults = useMemo(() => {
    if (
      ...
      !searchParams.cpf &&
      !searchParams.cns &&
      !searchParams.nomeMae &&
      !searchParams.endereco &&
      !searchParams.microarea &&
    ...
    let filtered = allCitizens.filter(citizen => {
      ...
      if (searchParams.cpf) {
        matches =
          matches &&
          citizen.nu_cpf?.includes(searchParams.cpf.replace(/\D/g, ""));
      }
      if (searchParams.cns) {
      ...
      if (searchParams.nomeMae) {
        matches =
          ...
          citizen.no_mae
            ?.toLowerCase()
            .includes(searchParams.nomeMae.toLowerCase());
      }
      if (searchParams.endereco) {
        matches =
          ...
          citizen.endereco
            ?.toLowerCase()
            .includes(searchParams.endereco.toLowerCase());
      }
      ...
      if (searchParams.condition && searchParams.condition !== "all") {
        matches =
          matches && citizen.conditions?.includes(searchParams.condition);
      }
  ...
  return (
    <div className="space-y-6">
                ...
                <form onSubmit={handleAdvancedSearch} className="mt-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        value={searchParams.microarea}
                        onValueChange={v =>
                          setSearchParams({ ...searchParams, microarea: v })
                        }
                      >
                        <SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={v =>
                          setSearchParams({ ...searchParams, condition: v })
                        }
                      >
                        <SelectTrigger>
                          <SelectValue placeholder="Todas" />
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={v =>
                          setSearchParams({ ...searchParams, status: v })
                        }
                      >
                        <SelectTrigger>
                          <SelectValue />
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-between mt-6 pt-6 border-t">
                <p className="text-sm text-gray-500">
                  ...
                  de {searchResults.length} resultados
                </p>
                <div className="flex items-center gap-2">
                  <Button
                    variant="outline"
      ...
      {(searchTerm ||
        Object.values(searchParams).some(v => v && v !== "all")) &&
        searchResults.length === 0 && (
          <Card className="shadow-lg border-0 bg-white/90">
