      ...
      <Card className="shadow-xl border-0 bg-white/90 backdrop-blur-sm overflow-hidden">
        ...
        <CardContent className="pt-0 -mt-12">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 text-center mb-6">
            <div
              className={`text-6xl font-black ${getScoreColor(overallScore)}`}
            >
              {overallScore}%
            </div>
            ...
            <div className="flex items-center justify-center gap-2 mt-3">
              ...
              <span
                className={`text-sm font-medium ${getScoreColor(overallScore)}`}
              >
                {overallScore >= 90
                  ? "Excelente"
                  : overallScore >= 70
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between mb-2">
                ...
                <span
                  className={`text-sm font-bold ${getScoreColor(completenessScore)}`}
                >
                  {completenessScore}%
                </span>
              </div>
            ...
            <div>
              <div className="flex justify-between mb-2">
                ...
                <span
                  className={`text-sm font-bold ${getScoreColor(consistencyScore)}`}
                >
                  {consistencyScore}%
                </span>
              </div>
