            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => 
                    setSelectedSections({...selectedSections, vaccination: checked as boolean})
                  }
                />
              ...
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => 
                    setSelectedSections({...selectedSections, chronic: checked as boolean})
                  }
                />
              ...
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => 
                    setSelectedSections({...selectedSections, visits: checked as boolean})
                  }
                />
              ...
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => 
                    setSelectedSections({...selectedSections, acs: checked as boolean})
                  }
                />
