...
export default function ConnectionsConfig() {
  ...
  const saveMutation = useMutation({
    mutationFn: async (data: any) => {
      ...
      for (const cfg of configsToSave) {
        const existing = configs.find((c: any) => c.config_key === cfg.config_key);
        if (existing) {
  ...
  const testConnection = async (type) => {
    setTesting((prev: any) => ({ ...prev, [type]: true }));
    // Simulate test
    await new Promise(resolve => setTimeout(resolve, 2000));
    setTesting((prev: any) => ({ ...prev, [type]: false }));
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e: any) => setFormData({ ...formData, pec_host: e.target.value })}
                />
              </div>
              <div className="space-y-2">
                <Label>Porta</Label>
                <Input
                  ...
                  onChange={(e: any) => setFormData({ ...formData, pec_port: e.target.value })}
                />
              </div>
              <div className="space-y-2">
                <Label>Usuário</Label>
                <Input
                  ...
                  onChange={(e: any) => setFormData({ ...formData, pec_user: e.target.value })}
                />
              </div>
              <div className="space-y-2">
                <Label>Senha</Label>
                <Input
                  ...
                  onChange={(e: any) => setFormData({ ...formData, pec_password: e.target.value })}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e: any) => setFormData({ ...formData, pec_database: e.target.value })}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e: any) => setFormData({ ...formData, cns_api_url: e.target.value })}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e: any) => setFormData({ ...formData, cns_api_key: e.target.value })}
                />
              </div>
            </div>
            <div className="flex justify-end gap-3 pt-4 border-t">
