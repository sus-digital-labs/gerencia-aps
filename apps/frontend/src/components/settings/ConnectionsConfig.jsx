...
export default function ConnectionsConfig() {
  ...
  const saveMutation = useMutation({
    mutationFn: async data => {
      ...
      const configsToSave = [
        {
          config_key: "pec_host",
          config_value: data.pec_host,
          category: "database",
          is_sensitive: false,
        },
        {
          config_key: "pec_port",
          config_value: data.pec_port,
          category: "database",
          is_sensitive: false,
        },
        {
          config_key: "pec_user",
          config_value: data.pec_user,
          category: "database",
          is_sensitive: false,
        },
        {
          config_key: "pec_password",
          config_value: "********",
          category: "database",
          is_sensitive: true,
        },
        {
          config_key: "pec_database",
          config_value: data.pec_database,
          category: "database",
          is_sensitive: false,
        },
        {
          config_key: "cns_api_url",
          config_value: data.cns_api_url,
          category: "api",
          is_sensitive: false,
        },
        {
          config_key: "cns_api_key",
          config_value: "********",
          category: "api",
          is_sensitive: true,
        },
  ...
  const testConnection = async type => {
    ...
    toast.success(
      `Conexão ${type === "pec" ? "e-SUS PEC" : "API CNS"} testada com sucesso!`
    );
  };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setFormData({ ...formData, pec_host: e.target.value })
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setFormData({ ...formData, pec_port: e.target.value })
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setFormData({ ...formData, pec_user: e.target.value })
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setFormData({ ...formData, pec_password: e.target.value })
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setFormData({ ...formData, pec_database: e.target.value })
                  }
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setFormData({ ...formData, cns_api_url: e.target.value })
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setFormData({ ...formData, cns_api_key: e.target.value })
                  }
                />
              </div>
            </div>
        ...
        <CardContent className="p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-amber-700">
              As senhas e chaves de API são armazenadas de forma criptografada e
              nunca são exibidas após salvas. Para atualizar, digite um novo
              valor.
            </p>
          </div>
        </CardContent>
