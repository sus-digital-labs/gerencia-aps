...
import { Key, Shield, Save, RefreshCw } from "lucide-react";
...
const PERMISSIONS = [
  { key: "dashboard.view", name: "Ver Dashboard", module: "Dashboard" },
  {
    ...
    name: "Exportar Dados do Dashboard",
    module: "Dashboard",
  },
  ...
  {
    key: "vigilancia.edit",
    name: "Editar Dados Vigilância",
    module: "Vigilância",
  },
  {
    key: "data_quality.view",
    name: "Ver Qualidade de Dados",
    module: "Qualidade",
  },
  {
    key: "data_quality.request_edit",
    name: "Solicitar Edição",
    module: "Qualidade",
  },
  {
    key: "data_quality.approve_edit",
    name: "Aprovar Edições",
    module: "Qualidade",
  },
...
const DEFAULT_PERMISSIONS = {
  ...
  gestor_municipal: [
    ...
    "vigilancia.edit",
    "data_quality.view",
    "data_quality.request_edit",
    "data_quality.approve_edit",
    "settings.view",
    "settings.logs",
  ],
  coordenador_ubs: [
    ...
    ROLES.forEach(role => {
      ...
      PERMISSIONS.forEach(perm => {
        const saved = savedPermissions.find(
          sp => sp.role === role && sp.permission_key === perm.key
        );
        state[role][perm.key] = saved
          ? saved.is_allowed
          : DEFAULT_PERMISSIONS[role]?.includes(perm.key);
      });
    });
    return state;
  });
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-gray-50">
                  <TableHead className="w-64 sticky left-0 bg-gray-50 z-10">
                    Permissão
                  </TableHead>
                  {ROLES.map(role => (
