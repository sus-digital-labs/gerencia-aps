            ...
            >
              {topThree[1] && (
                <div className={`w-full rounded-2xl p-4 border-2 ${getPodiumStyle(2)} text-center`}>
                  ...
                  <Badge className={`mt-2 ${teamTypeColors[topThree[1].team_type]}`}>
            ...
            >
              {topThree[0] && (
                <div className={`w-full rounded-2xl p-4 border-2 ${getPodiumStyle(1)} text-center`}>
                  ...
                  <Badge className={`mt-2 ${teamTypeColors[topThree[0].team_type]}`}>
            ...
            >
              {topThree[2] && (
                <div className={`w-full rounded-2xl p-4 border-2 ${getPodiumStyle(3)} text-center`}>
                  ...
                  <Badge className={`mt-2 ${teamTypeColors[topThree[2].team_type]}`}>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge className={`${teamTypeColors[team.team_type]} text-xs`}>
                      {team.team_type}
                    </Badge>
