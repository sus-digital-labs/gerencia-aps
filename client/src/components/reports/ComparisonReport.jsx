...
export default function ComparisonReport({ teams, areas, visits, indicators, onExportCSV, onExportPDF }) {
  ...
  const comparisonData = useMemo(() => {
    if (comparisonType === 'microareas') {
      ...
      return Object.values(microareaMap).map(ma => ({
        ...ma,
    ...
    if (comparisonType === 'equipes') {
      ...
      }).sort((a, b) => parseFloat(b.avgIndicator) - parseFloat(a.avgIndicator));
    }
