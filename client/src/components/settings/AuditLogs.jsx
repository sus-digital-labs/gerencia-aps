...
export default function AuditLogs() {
  ...
  const stats = useMemo(() => ({
    ...
    logins: filteredLogs.filter(l => l.action_type === 'login_success').length,
    exports: filteredLogs.filter(l => l.action_type === 'data_export' || l.action_type === 'report_generate').length
  }), [filteredLogs]);
