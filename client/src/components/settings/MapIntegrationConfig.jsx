...
export default function MapIntegrationConfig() {
  ...
  const selectedTile = currentTileOptions.find(t => t.value === mapTileStyle) || currentTileOptions[0];
            ...
            <div className="flex gap-2">
              <div className="relative flex-1">
                <Input
                  ...
                  placeholder="AIzaSy..."
                  value={googleApiKey}
                  onChange={(e) => { setGoogleApiKey(e.target.value); setIsDirty(true); setKeyValid(null); }}
        ...
        <div className="grid grid-cols-3 gap-3">
          <div>
            ...
            <Input
              ...
              step="0.0001"
              value={latCentro}
              onChange={(e) => { setLatCentro(e.target.value); setIsDirty(true); }}
          ...
          <div>
            ...
            <Input
              ...
              step="0.0001"
              value={lngCentro}
              onChange={(e) => { setLngCentro(e.target.value); setIsDirty(true); }}
              className="text-sm font-mono"
              placeholder="-40.5736"
            />
          </div>
          <div>
            ...
            <Input
              ...
              max="20"
              value={zoomInicial}
              onChange={(e) => { setZoomInicial(e.target.value); setIsDirty(true); }}
              className="text-sm"
              placeholder="13"
            />
          </div>
