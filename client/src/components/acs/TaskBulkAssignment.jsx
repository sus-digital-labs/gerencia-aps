...
import { 
  Users, Filter, ClipboardList, MapPin, Heart, Bug, Baby, UserPlus,
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={filters.microarea} onValueChange={(v) => setFilters({ ...filters, microarea: v })}>
                  <SelectTrigger>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {filters.condition === 'alto_risco_cv' && (
                <div className="space-y-2">
                  ...
                  <Select value={filters.care_plan_status} onValueChange={(v) => setFilters({ ...filters, care_plan_status: v })}>
                    <SelectTrigger>
