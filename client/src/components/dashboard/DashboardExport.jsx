            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => 
                    setSelectedSections({...selectedSections, vaccination: checked})
                  }
                />
              ...
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => 
                    setSelectedSections({...selectedSections, chronic: checked})
                  }
                />
              ...
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => 
                    setSelectedSections({...selectedSections, visits: checked})
                  }
                />
