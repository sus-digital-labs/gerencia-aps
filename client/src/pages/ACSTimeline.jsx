...
export default function ACSTimeline() {
  ...
  const [editModal, setEditModal] = useState({ open: false, field: '', value: '', citizenId: '' });
            ...
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-blue-600">
                  {sortedVisits.filter(v => v.desfecho === 'visita_realizada').length}
                </p>
            ...
            <CardContent className="p-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-red-600">
                  {sortedVisits.filter(v => getInconsistencies(v).length > 0).length}
                </p>
