      ...
      <div className="bg-gradient-to-r from-pink-600 to-purple-600 text-white">
        <div className="max-w-[1600px] mx-auto px-6 py-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-black tracking-tight">Saúde da Mulher</h1>
              <p className="text-white/70">Acompanhamento de Preventivo, Mamografia e Vacinas</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[1600px] mx-auto px-6 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="bg-white shadow-lg mb-6">
            <TabsTrigger value="preventivo" className="gap-2 data-[state=active]:bg-pink-600 data-[state=active]:text-white">
              <FileText className="w-4 h-4" />
              Exame Preventivo
            </TabsTrigger>
            <TabsTrigger value="mamografia" className="gap-2 data-[state=active]:bg-purple-600 data-[state=active]:text-white">
              <Heart className="w-4 h-4" />
              Mamografia
            </TabsTrigger>
            <TabsTrigger value="vacina" className="gap-2 data-[state=active]:bg-rose-600 data-[state=active]:text-white">
