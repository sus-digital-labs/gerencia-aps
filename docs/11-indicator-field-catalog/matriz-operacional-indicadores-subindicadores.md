...
> - **6 regras operacionais CVAT**: CVAT1-CVAT6
>
> Registro canonico JSON: `.ai/CONTEXT/indicator-registry.json`
> Registro canonico MD: [official-indicators-registry.md](official-indicators-registry.md)
...
> **AVISO (2026-05-21):** A decomposicao C2.1/C2.2/C3.1/C3.2/C5.1/C5.2 pertence ao Previne Brasil (programa anterior) e NAO ao Saude Brasil 360. A tabela abaixo com essas linhas e mantida apenas como referencia historica do agente Rust. Para o escopo canonico, usar `.ai/CONTEXT/indicator-registry.json`.
