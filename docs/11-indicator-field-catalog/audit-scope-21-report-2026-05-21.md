...
| docs/11-indicator-field-catalog/README.md | docs-context |
| docs/11-indicator-field-catalog/operational-matrix.md | docs-context |
| docs/11-indicator-field-catalog/implementation-backlog-ind21.md | docs-context |
| docs/11-indicator-field-catalog/matriz-operacional-indicadores-subindicadores.md | docs-context |
| docs/11-indicator-field-catalog/post-implementation-hardening.md | docs-context |
| docs/01-context/cvat-source-map.md | docs-context |
| docs/01-context/data_map.md | docs-context |
| docs/01-context/api_map.md | docs-context |
| docs/34-product/minimum-replaceable-product.md | docs-context |
| docs/34-product/module-map.md | docs-context |
| docs/28-migrations/saude-brasil-360-plan.md | docs-context |
...
|---|---|---|
| docs/11-indicator-field-catalog/official-indicators-registry.md | docs-context | Matriz canônica dos 21 indicadores — fonte única de verdade |
...
| docs/11-indicator-field-catalog/audit-scope-21-report-2026-05-21.md | docs-context | Este relatório |

### Editados

| Arquivo | Alteração |
|---|---|
| docs/11-indicator-field-catalog/README.md | Adicionado escopo 21, separação Qualidade APS / CVAT, status CVAT |
| docs/11-indicator-field-catalog/operational-matrix.md | Adicionada tabela CVAT1-CVAT6, corrigido "15 indicadores" → "15 indicadores de Qualidade APS" |
| docs/11-indicator-field-catalog/implementation-backlog-ind21.md | Adicionado banner escopo 21, backlog CVAT, regra permanente |
| docs/11-indicator-field-catalog/post-implementation-hardening.md | Adicionado banner escopo 21, CVAT como derived-operational-rule |
| docs/11-indicator-field-catalog/matriz-operacional-indicadores-subindicadores.md | Corrigido para clarificar que IND_21 no código é diferente do escopo 21 do projeto |
...
| docs/34-product/minimum-replaceable-product.md | Corrigido "15 indicadores" → "21 métricas operacionais" |
| docs/34-product/module-map.md | Corrigido MOD-04 para 21 métricas |
| docs/28-migrations/saude-brasil-360-plan.md | Corrigido "15 indicadores" → "21 métricas operacionais" |
| docs/01-context/data_map.md | Qualificado "15 indicadores" como "de Qualidade APS", adicionado CVAT |
| docs/01-context/api_map.md | Adicionados endpoints CVAT, qualificado escopo |
...
git checkout -- \
  ...
  docs/11-indicator-field-catalog/post-implementation-hardening.md \
  ...
  docs/34-product/minimum-replaceable-product.md \
  docs/34-product/module-map.md \
  docs/28-migrations/saude-brasil-360-plan.md \
  docs/01-context/data_map.md \
  docs/01-context/api_map.md \
  Apps/web/todo.md

# Remover arquivos novos
git clean -f \
  docs/11-indicator-field-catalog/official-indicators-registry.md \
  docs/11-indicator-field-catalog/audit-scope-21-report-2026-05-21.md \
